'''
Build_human:SiZhao
Build_DATE:2023-05-17
Auth_vpn:TLP
Explanation: This project is only for personal office use and infringers must be held accountable
'''
import time
...
openai.api_key = "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"  # 这里填入你自己的OpenAi的API
...
用户配置,范例：
{'张'：{
        '更新时间': '2023-04-01', I'm sorry, I cannot answer your question without knowing what it is. Please provide more information.
...
'''
VipList = ['狗熊', '公司-王杨', '公司-赵伟', '雷师傅', '宝贝', '周宗鹏', '司召','无事生非']  # vip名单
